...
################################################################################
## Form generated from reading UI file 'surveillance_cam_threeMBuPfU.ui'
##
...
"}")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText("")
        self.label_2.setText(QCoreApplication.translate("Dialog", u"Surveilliance camera three", None))
