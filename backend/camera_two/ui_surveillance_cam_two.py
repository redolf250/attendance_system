...
################################################################################
## Form generated from reading UI file 'surveillance_cam_twowZamrI.ui'
##
...
"}")
        ...
        self.brightness.setSliderPosition(30)
...
"}")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText("")
        self.label_2.setText(QCoreApplication.translate("Dialog", u"Surveilliance camera two", None))
